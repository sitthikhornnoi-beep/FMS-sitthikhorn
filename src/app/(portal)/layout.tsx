    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground selection:bg-primary/20">
      ...
      <header className="adm-head sticky top-0 z-50 h-[64px] [--adm-head-h:64px] [--adm-gap:14px] px-3 sm:px-6">
        ...
        <Link className="brand-blk !w-auto shrink-0 pr-2 mr-2" href="/">
          ...
          <div className="t">
            <b>{locale === "th" ? "วิทยาลัยสงฆ์พุทธโสธร มจร" : "MCU Phutthasothon"}</b>
            <span>{locale === "th" ? "หลักสูตรรัฐศาสตรบัณฑิต (ร.บ.)" : "Bachelor of Political Science"}</span>
          </div>
        </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              <Link href="/" className="inline-flex items-center gap-3.5 group">
                ...
                <div>
                  <div className="font-bold text-white text-base sm:text-lg tracking-tight leading-snug">
                    {locale === "th" ? "วิทยาลัยสงฆ์พุทธโสธร มจร" : "MCU Phutthasothon Buddhist College"}
                  </div>
              ...
              <p className="text-xs sm:text-sm text-[var(--ink-band-muted)] leading-relaxed max-w-md pt-1">
                {locale === "th"
                  ? "จัดการศึกษาพระพุทธศาสนาบูรณาการกับศาสตร์สมัยใหม่ เพื่อพัฒนาจิตใจและสังคม ผลิตบัณฑิตที่มีคุณธรรม เชี่ยวชาญการบริหารงานรัฐกิจ และพร้อมพัฒนาสังคมสู่ความยั่งยืน"
                  : "Empowering visionary leaders and innovative practitioners through Buddhist wisdom and modern political science."}
              </p>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[var(--ink-band-muted)]">
            <p className="text-center sm:text-left">
              © {new Date().getFullYear()} {locale === "th" ? "วิทยาลัยสงฆ์พุทธโสธร มหาวิทยาลัยมหาจุฬาลงกรณราชวิทยาลัย" : "MCU Phutthasothon Buddhist College"}. All rights reserved.
            </p>
