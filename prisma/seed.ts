...
async function main() {
  ...
  const programsData = [
    ...
    },
    {
      ...
      degreeTh: "รัฐศาสตรบัณฑิต (รัฐศาสตร์)",
      degreeEn: "Bachelor of Political Science (Political Science)",
      ...
      totalCredits: 132,
      studyDuration: "4 ปี",
      tuitionFee: "ประมาณ ๑๒,๗๕๐ บาท / ปี (ตามระเบียบมหาวิทยาลัย)",
      descriptionTh: "จัดการศึกษาพระพุทธศาสนาบูรณาการกับศาสตร์สมัยใหม่ เพื่อพัฒนาจิตใจและสังคม ผลิตบัณฑิตที่มีคุณธรรม เชี่ยวชาญการบริหารงานรัฐกิจ การเมืองการปกครอง นโยบายสาธารณะ และพร้อมพัฒนาสังคมสู่ความยั่งยืน",
      descriptionEn: "Integrating Buddhist wisdom with modern political science to empower visionary leaders in public governance, policy formulation, and sustainable societal development.",
      philosophyTh: "มุ่งผลิตบัณฑิตทางรัฐศาสตร์ที่เปี่ยมไปด้วยความรู้ควบคู่คุณธรรม มีภาวะผู้นำ ตระหนักถึงอุดมการณ์ประชาธิปไตยบนฐานของพุทธนวัตกรรมและการเสียสละรับใช้ท้องถิ่น คณะสงฆ์ ชุมชน สังคม ประเทศ และประชาคมอาเซียน",
      philosophyEn: "Aiming to produce graduates in political science with knowledge and virtue, leadership qualities, awareness of democratic ideology grounded in Buddhist innovation, and dedication to serving the locality, Sangha, community, society, nation, and ASEAN community.",
      careerPaths: [
        "ปลัดอำเภอ ปลัดองค์กรปกครองส่วนท้องถิ่น (อบต., เทศบาล, อบจ.)",
        "พนักงานภาครัฐ รัฐวิสาหกิจ องค์กรอิสระ และเอกชน",
        "ข้าราชการพลเรือน ทหาร และตำรวจ",
        "ครู อาจารย์ในสถาบันการศึกษาทั้งภาครัฐและเอกชน",
        "นักการเมือง นักวิชาการ นักปกครอง และนักวิเคราะห์นโยบายและแผน",
      ],
      plos: [
        {
          code: "PLO1",
          titleTh: "สามารถอธิบายหลักการพื้นฐานและมโนทัศน์สำคัญทางด้านรัฐศาสตร์ได้",
          titleEn: "Explain fundamental principles and core concepts in political science",
          description: "รอบรู้ในหลักการพื้นฐาน มโนทัศน์ และทฤษฎีทางรัฐศาสตร์",
        },
        {
          code: "PLO2",
          titleTh: "สามารถวิเคราะห์และประยุกต์ใช้ความรู้ในสาขาวิชาของตนเพื่อทำความเข้าใจและอธิบายปรากฏการณ์ร่วมสมัยทางสังคมและการเมืองได้",
          titleEn: "Analyze and apply political science knowledge to understand and explain contemporary socio-political phenomena",
          description: "วิเคราะห์และอธิบายปรากฏการณ์ร่วมสมัยได้อย่างมีวิจารณญาณ",
        },
        {
          code: "PLO3",
          titleTh: "สามารถค้นคว้าหาความรู้ทางรัฐศาสตร์จากแหล่งข้อมูลต่าง ๆ มาวิเคราะห์ ประมวลผล เพื่อสร้างข้อเสนอทางวิชาการได้อย่างเป็นระบบ",
          titleEn: "Conduct political science research from diverse sources, analyze data, and formulate academic proposals systematically",
          description: "ค้นคว้า วิจัย และสร้างสรรค์ข้อเสนอทางวิชาการและนโยบายได้อย่างเป็นระบบ",
        },
        {
          code: "PLO4",
          titleTh: "มีคุณธรรม จริยธรรม ความรับผิดชอบ และจรรยาบรรณในการประกอบอาชีพ และมีจิตสำนึกรับผิดชอบต่อสังคม",
          titleEn: "Demonstrate ethics, moral responsibility, professional integrity, and public consciousness",
          description: "ยึดมั่นในจรรยาบรรณวิชาชีพและจิตสำนึกสาธารณะ",
        },
        {
          code: "PLO5",
          titleTh: "สามารถทำงานร่วมกับผู้อื่น ยอมรับความแตกต่างหลากหลาย และวิจารณ์โต้แย้งอย่างเป็นเหตุเป็นผล",
          titleEn: "Collaborate effectively with others, respect diversity, and engage in reasoned discourse and constructive debate",
          description: "มีภาวะผู้นำ มนุษยสัมพันธ์ และยอมรับความหลากหลายในสังคมพหุวัฒนธรรม",
        },
        {
          code: "PLO6",
          titleTh: "สามารถใช้เทคโนโลยีสารสนเทศ ภาษาไทยและภาษาต่างประเทศในการสื่อสารและนำเสนอได้อย่างมีประสิทธิภาพ",
          titleEn: "Utilize information technology, Thai, and foreign languages for effective communication and professional presentation",
          description: "ประยุกต์ใช้เครื่องมือดิจิทัลและการสื่อสารทั้งภาษาไทยและต่างประเทศอย่างเชี่ยวชาญ",
        },
      ],
      courseStructure: [
        {
          groupName: "๑. หมวดวิชาศึกษาทั่วไป (General Education)",
          credits: 24,
          description: "วิชาบังคับ ๑๘ หน่วยกิต และวิชาเลือก ๖ หน่วยกิต",
        },
        {
          groupName: "๒. หมวดวิชาเฉพาะด้าน - วิชากลุ่มพระพุทธศาสนา",
          credits: 30,
          description: "กลุ่มวิชาพระพุทธศาสนาและวิปัสสนากรรมฐาน ๓๐ หน่วยกิต",
        },
        {
          groupName: "๒. หมวดวิชาเฉพาะด้าน - วิชาแกนรัฐศาสตร์",
          credits: 33,
          description: "วิชาแกนพื้นฐานทางรัฐศาสตร์และรัฐประศาสนศาสตร์ ๓๓ หน่วยกิต",
        },
        {
          groupName: "๒. หมวดวิชาเฉพาะด้าน - วิชาเฉพาะสาขาวิชารัฐศาสตร์",
          credits: 33,
          description: "วิชาเอกบังคับเฉพาะสาขาวิชารัฐศาสตร์ ๓๓ หน่วยกิต",
        },
        {
          groupName: "๒. หมวดวิชาเฉพาะด้าน - วิชาเลือกเฉพาะสาขาวิชารัฐศาสตร์",
          credits: 6,
          description: "วิชาเลือกเฉพาะทางด้านการเมืองการปกครองและกฎหมาย ๖ หน่วยกิต",
        },
        {
          groupName: "๓. หมวดวิชาเลือกเสรี (Free Electives)",
          credits: 6,
          description: "วิชาเลือกเสรีตามความสนใจของผู้เรียน ๖ หน่วยกิต",
        },
      ],
      studyPlan: [
        {
          ...
          semester: 1,
          courses: [
            { code: "000 101", nameTh: "มนุษย์กับสังคม", nameEn: "Man and Society", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 102", nameTh: "กฎหมายทั่วไป", nameEn: "General Law", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 107", nameTh: "ความรู้เบื้องต้นเกี่ยวกับการเมืองการปกครอง", nameEn: "Introduction to Politics and Government", credits: 3, type: "ศึกษาทั่วไป (เลือก)" },
            { code: "000 108", nameTh: "เศรษฐศาสตร์เบื้องต้น", nameEn: "Introduction to Economics", credits: 3, type: "ศึกษาทั่วไป (เลือก)" },
            { code: "000 239", nameTh: "ธรรมะภาคภาษาอังกฤษ", nameEn: "Dhamma in English", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "000 136", nameTh: "ภาษาบาลี", nameEn: "Pali", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "401 101", nameTh: "ความรู้เบื้องต้นทางรัฐศาสตร์", nameEn: "Introduction to Political Science", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
          ],
        },
        {
          year: 1,
          semester: 2,
          courses: [
            { code: "000 205", nameTh: "ปรัชญาเบื้องต้น", nameEn: "Introduction to Philosophy", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 228", nameTh: "สันติศึกษา", nameEn: "Peace Education", credits: 3, type: "วิชาเลือกเสรี" },
            { code: "000 237", nameTh: "ประวัติพระพุทธศาสนา", nameEn: "History of Buddhism", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "000 140", nameTh: "กรรมฐาน ๑", nameEn: "Buddhist Meditation I", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "402 101", nameTh: "ความรู้เบื้องต้นทางรัฐประศาสนศาสตร์", nameEn: "Introduction to Public Administration", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 103", nameTh: "ปรัชญาการเมืองเบื้องต้น", nameEn: "Introduction to Political Philosophy", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
          ],
        },
        {
          year: 2,
          semester: 1,
          courses: [
            { code: "000 103", nameTh: "คอมพิวเตอร์และเทคโนโลยีดิจิทัล", nameEn: "Computer and Digital Technology", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 204", nameTh: "ภาษาอังกฤษเพื่อการสื่อสาร", nameEn: "English for Communications", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 230", nameTh: "หลักธรรมาภิบาล", nameEn: "Good Governance", credits: 3, type: "วิชาเลือกเสรี" },
            { code: "000 238", nameTh: "เทศกาลและพิธีกรรมพระพุทธศาสนา", nameEn: "Buddhist Festival and Traditions", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "000 241", nameTh: "กรรมฐาน ๒", nameEn: "Buddhist Meditation II", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "401 204", nameTh: "ความรู้เบื้องต้นทางความสัมพันธ์ระหว่างประเทศ", nameEn: "Introduction to International Relation", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 205", nameTh: "การเมืองการปกครองเปรียบเทียบ", nameEn: "Comparative Politics and Government", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
          ],
        },
        {
          year: 2,
          semester: 2,
          courses: [
            { code: "000 206", nameTh: "คณิตศาสตร์และสถิติเพื่อการวิจัย", nameEn: "Mathematics and Statistics for Research", credits: 3, type: "ศึกษาทั่วไป (บังคับ)" },
            { code: "000 134", nameTh: "วรรณกรรมพระพุทธศาสนา", nameEn: "Buddhist Literature", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "000 135", nameTh: "พระไตรปิฎกศึกษา", nameEn: "Tipitaka Studies", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "401 206", nameTh: "ภาษาอังกฤษในสาขารัฐศาสตร์", nameEn: "English in the Field of Political Science", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 207", nameTh: "ทฤษฎีการเมืองและจริยธรรมทางการเมือง", nameEn: "Political Theories and Political Ethics", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 211", nameTh: "กฎหมายปกครอง", nameEn: "Administrative Law", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
          ],
        },
        {
          year: 3,
          semester: 1,
          courses: [
            { code: "000 342", nameTh: "กรรมฐาน ๓", nameEn: "Buddhist Meditation III", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "401 308", nameTh: "สถาบันการเมืองและรัฐธรรมนูญ", nameEn: "Political Institutions and Constitutions", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 309", nameTh: "ระเบียบวิธีวิจัยทางรัฐศาสตร์", nameEn: "Political Science Research Methodology", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 312", nameTh: "การเมืองและนโยบายสาธารณะ", nameEn: "Politics and Public Policy", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 313", nameTh: "การเมืองการปกครองส่วนภูมิภาคและส่วนท้องถิ่นของไทย", nameEn: "Thai Local Government and Politics", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 314", nameTh: "การสื่อสารทางการเมือง", nameEn: "Political Communication", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 321", nameTh: "กฎหมายวิธีพิจารณาความอาญา", nameEn: "Law of Criminal Procedure", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
          ],
        },
        {
          year: 3,
          semester: 2,
          courses: [
            { code: "000 443", nameTh: "กรรมฐาน ๔", nameEn: "Buddhist Meditation IV", credits: 3, type: "กลุ่มพระพุทธศาสนา" },
            { code: "401 310", nameTh: "พรรคการเมือง กลุ่มผลประโยชน์และการเลือกตั้ง", nameEn: "Political Parties, Interest Groups and Elections", credits: 3, type: "วิชาแกนรัฐศาสตร์" },
            { code: "401 320", nameTh: "กฎหมายอาญา ๑", nameEn: "Criminal Law 1", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 315", nameTh: "รัฐศาสตร์ตามแนวพระพุทธศาสนา", nameEn: "Political Science in Buddhism", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 316", nameTh: "การวิเคราะห์การเมืองการปกครองของไทย", nameEn: "Analysis of Thai Politics and Government", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 322", nameTh: "กฎหมายลักษณะพยาน", nameEn: "Law of Witness", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
          ],
        },
        {
          year: 4,
          semester: 1,
          courses: [
            { code: "401 417", nameTh: "การศึกษาอิสระทางรัฐศาสตร์", nameEn: "Independent Study on Political Science", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 418", nameTh: "สัมมนาปัญหาทางการเมืองการปกครองของไทย", nameEn: "Seminar on Problems of Politics and Government of Thailand", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 424", nameTh: "กฎหมายแรงงานและสวัสดิการสังคม", nameEn: "Law of Labour and Welfare", credits: 3, type: "วิชาเลือกเฉพาะสาขาวิชารัฐศาสตร์" },
          ],
        },
        {
          year: 4,
          semester: 2,
          courses: [
            { code: "401 419", nameTh: "ประสบการณ์สาขารัฐศาสตร์ (การฝึกภาคสนาม)", nameEn: "Experience in Political Science (Field Practicum)", credits: 3, type: "วิชาเฉพาะสาขารัฐศาสตร์" },
            { code: "401 426", nameTh: "นวัตกรรมกับการเมืองไทย", nameEn: "Innovation and Thai Politics", credits: 3, type: "วิชาเลือกเฉพาะสาขาวิชารัฐศาสตร์" },
          ],
        },
      ],
      imageUrl: "https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=1200&q=80",
      pdfUrl: "/uploads/tqf2-political-science-2567.pdf",
      displayOrder: 1,
    },
    {
      code: "MS-AI-2567",
  ...
  if (adminUser) {
    ...
    // 4. MCU Political Science Appointment Order (APPROVED)
    await prisma.document.upsert({
      where: { tenantId_docNumber: { tenantId: core.tenantId, docNumber: "คำสั่ง วส.พธ. ๖๗/๒๕๖๗" } },
      update: {},
      create: {
        tenantId: core.tenantId,
        docType: "COMMAND",
        ...
        sequenceNumber: 2,
        docYear: currentDocYear,
        title: "คำสั่งวิทยาลัยสงฆ์พุทธโสธร ที่ ๖๗/๒๕๖๗ เรื่อง แต่งตั้งอาจารย์ผู้รับผิดชอบหลักสูตรและอาจารย์ประจำหลักสูตรรัฐศาสตรบัณฑิต (หลักสูตรปรับปรุง พ.ศ. ๒๕๖๗)",
        content: "เพื่อให้การจัดการเรียนการสอนหลักสูตรรัฐศาสตรบัณฑิต สาขาวิชารัฐศาสตร์ (หลักสูตรปรับปรุง พ.ศ. ๒๕๖๗) ดำเนินไปด้วยความเรียบร้อย มีประสิทธิภาพ บรรลุตามวัตถุประสงค์ของหลักสูตร และเป็นไปตามเกณฑ์มาตรฐานหลักสูตรระดับอุดมศึกษา จึงแต่งตั้งคณาจารย์ผู้รับผิดชอบหลักสูตรและอาจารย์ประจำหลักสูตร...",
        submitterId: adminUser.id,
        approvedAt: new Date(),
        completedAt: new Date(),
        attachments: [
